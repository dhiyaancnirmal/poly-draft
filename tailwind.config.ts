  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow-sm": "0 0 10px -3px hsl(var(--primary))",
        "glow-lg": "0 0 30px -8px hsl(var(--primary))",
        card: "0 8px 30px rgba(0,0,0,0.12)",
        "card-hover": "0 12px 40px rgba(0,0,0,0.16)",
        "card-dark": "0 8px 32px -12px rgba(0,0,0,0.5)",
        "card-dark-hover": "0 16px 48px -16px rgba(0,0,0,0.6)",
        "nav": "0 -4px 24px -8px rgba(0,0,0,0.3)",
